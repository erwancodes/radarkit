...
function RadarBench() {
  return <div className="radar-bench" aria-label="Vue d’activité du radar"><div className="bench-top"><span>RADARKIT / ROBOTIQUE</span><span className="bench-live"><span className="status-dot" /> PRÊT</span></div><div className="bench-stage"><div className="bench-ring ring-one" /><div className="bench-ring ring-two" /><div className="bench-ring ring-three" /><div className="bench-cross cross-x" /><div className="bench-cross cross-y" /><div className="bench-sweep" /><div className="bench-point point-one" /><div className="bench-point point-two" /><div className="bench-point point-three" /><div className="bench-readout"><span>{signals.length}</span><small>signaux<br />chargés</small></div></div><div className="bench-bottom"><span>05:00 CET / RUN QUOTIDIEN</span><span>2 BORNAGES / {sources.length} FLUX</span></div></div>
}
